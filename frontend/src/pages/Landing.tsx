        ...
        <div className="page-enter">
            ...
            <section className="hero container">
                ...
                <div className="hero-badge">
                    <span className="dot" />
                    Now with 22 interactive simulations
                </div>

                <h1>
                    <span className="line">Explore the mathematics</span>
                    <span className="line">of <span className="gradient-text">strategic interaction</span></span>
                </h1>

                <p className="hero-subtitle">
                    Run game theory simulations instantly. From the Prisoner's Dilemma to
                    Multi-Agent Negotiation — visualize equilibria, test strategies, and
            ...
            <section id="how-it-works" className="how-it-works container">
                ...
                <div className="steps-timeline stagger-children">
                    <div className="step-card reveal">
                        ...
                        <h3>Choose a Game</h3>
                        <p>Browse 22 simulations across classical, underrated, and innovative game theory models.</p>
                    </div>
                    <div className="step-card reveal">
                        <div className="step-number">2</div>
                        <h3>Configure & Run</h3>
                        <p>Adjust parameters like strategies, rounds, and payoffs. Hit run and watch results compute in real time.</p>
                    </div>
                    <div className="step-card reveal">
                        <div className="step-number">3</div>
                        <h3>Analyze Results</h3>
                        <p>Interactive charts, equilibria analysis, and theory cards explain the strategic insights behind each outcome.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="container">
                <div className="feature-grid stagger-children">
                    <div className="feature-card reveal">
                        ...
                        <h3>Lightning-Fast Simulation Engine</h3>
                        <p>Server-side Python engine runs thousands of rounds instantly. From simple 2×2 games to complex multi-agent negotiations.</p>
                    </div>
                    <div className="feature-card reveal">
                        <div className="feature-icon">📊</div>
                        <h3>Interactive Visualizations</h3>
                        <p>Plotly-powered charts with real-time data. Cooperation rates, payoff distributions, strategy evolution — all beautifully rendered.</p>
                    </div>
                    <div className="feature-card reveal">
                        <div className="feature-icon">🧠</div>
            ...
            <footer className="container">
                <p>Built with ⚛️ React + 🐍 FastAPI &nbsp;|&nbsp; <a href="https://github.com">Source Code</a></p>
            </footer>
        </div>
    );
}
